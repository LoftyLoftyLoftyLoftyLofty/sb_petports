...
local navFamilies = {}
local navEdgeFamilyEnumerate = nil

local NAV_BOUNDS = "petports_navbounds"
local NAV_BOUNDS_FILL = 0.5
local navBoundaryNote = nil
local navGenerationCheck = nil
local navGenNow = nil
local navDrawBounds = nil
local navContradictThrough = nil
local navSeedBesideWall = nil
local navBoxForbidden = nil
